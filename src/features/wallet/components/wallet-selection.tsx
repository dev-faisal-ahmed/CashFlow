...
import { getWalletListForTransferApi } from "../wallet.api";
...
export const WalletSelection: FC<WalletSelectionProps> = ({ value, onChange, skipWalletId }) => {
  const { data: walletList, isLoading } = useQuery({
    queryKey: [queryKeys.wallet, "basic"],
