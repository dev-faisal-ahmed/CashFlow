...
export const Sheet: FC<ComponentProps<typeof SheetPrimitive.Root>> = ({ ...props }) => <SheetPrimitive.Root data-slot="sheet" {...props} />;
...
const SheetOverlay: FC<ComponentProps<typeof SheetPrimitive.Overlay>> = ({ className, ...props }) => (
...
type SheetContentProps = ComponentProps<typeof SheetPrimitive.Content> & { side?: "top" | "right" | "bottom" | "left" };
export const SheetContent: FC<SheetContentProps> = ({ className, children, side = "right", ...props }) => (
  <SheetPortal>
    <SheetOverlay />
