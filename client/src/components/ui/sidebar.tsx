...
import { ComponentProps, createContext, CSSProperties, FC, useCallback, useContext, useEffect, useMemo, useState } from "react";
...
type SidebarProviderProps = ComponentProps<"div"> & { defaultOpen?: boolean; open?: boolean; onOpenChange?: (open: boolean) => void };
...
export const SidebarTrigger: FC<ComponentProps<typeof Button>> = ({ className, onClick, ...props }) => {
...
export const SidebarInset: FC<ComponentProps<"main">> = ({ className, ...props }) => (
  <main
...
export const SidebarGroup: FC<ComponentProps<"div">> = ({ className, ...props }) => (
...
export const SidebarGroupAction: FC<SidebarGroupActionProps> = ({ className, asChild = false, ...props }) => {
  ...
  "peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm outline-hidden ring-sidebar-ring transition-[width,height,padding] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-data-[sidebar=menu-action]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-accent data-[active=true]:font-medium data-[active=true]:text-sidebar-accent-foreground data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2! [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",
  {
    variants: {
      ...
      size: {
        default: "h-8 text-sm",
        sm: "h-7 text-xs",
        lg: "h-12 text-sm group-data-[collapsible=icon]:p-0! px-4",
      },
    },
    defaultVariants: {
      variant: "default",
...
export const SidebarMenuAction: FC<SidebarMenuActionProps> = ({ className, asChild = false, showOnHover = false, ...props }) => {
  const Comp = asChild ? Slot : "button";
...
export const SidebarMenuBadge: FC<ComponentProps<"div">> = ({ className, ...props }) => (
  <div
...
export const SidebarMenuSub: FC<ComponentProps<"ul">> = ({ className, ...props }) => (
  <ul
...
export const SidebarMenuSubItem: FC<ComponentProps<"li">> = ({ className, ...props }) => (
  <li data-slot="sidebar-menu-sub-item" data-sidebar="menu-sub-item" className={cn("group/menu-sub-item relative", className)} {...props} />
);

type SidebarMenuSubButtonProps = ComponentProps<"a"> & { asChild?: boolean; size?: "sm" | "md"; isActive?: boolean };
